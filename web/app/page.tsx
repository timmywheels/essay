...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen" style={{ color: "var(--foreground)" }}>
      ...
      >
        <div
          className="max-w-4xl mx-auto px-6 flex items-stretch justify-between"
          style={{ height: "52px" }}
        >
          <Link
            href="/"
          ...
          <div className="flex items-stretch">
            ...
            <div
              ...
              style={{ width: "1px", borderRight: "1px dashed var(--border)" }}
            />
            {session ? (
              <Link
                href="/dashboard"
      ...
      <main>
        ...
        <section className="max-w-2xl mx-auto px-6 py-24 text-center">
          <TextSelectIcon
            size={64}
            className="mx-auto mb-8 landing-icon"
          ...
          <div className="flex flex-col sm:flex-row items-stretch mb-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="cta-secondary flex-1 inline-flex items-center justify-center gap-2 py-4 text-sm font-medium transition-opacity hover:opacity-70"
          ...
          >
            ...
            >
              ...
              <p className="leading-relaxed">
                Connect a GitHub repo, point your domain, done. No build
                configs, no YAML graveyard, no dashboards to babysit.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="leading-relaxed">
                Draft in Vim at 2am. Edit in the browser on your phone. Paste
                from Cursor. It's all the same markdown files in the same
        ...
        <section style={{ borderTop: "1px dashed var(--border)" }}>
          <div className="max-w-4xl mx-auto px-6 py-16">
            <h2
              className="text-sm font-medium mb-10 text-center"
              style={{ color: "var(--foreground)" }}
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div style={{ border: "1px dashed var(--border)" }}>
                ...
                {/* terminal body */}
                <div
                  className="px-5 py-5 font-mono text-xs space-y-3"
                  style={{
                ...
                >
                  <div className="space-y-1">
                    <p>
                      <span style={{ opacity: 0.5 }}>$</span> essay new{" "}
                      <span style={{ opacity: 0.8 }}>
                        &quot;why I left substack&quot;
                      </span>
                    </p>
                    <p style={{ opacity: 0.6 }}>
                      &nbsp;&nbsp;→ drafts/why-i-left-substack.md
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p>
                      <span style={{ opacity: 0.5 }}>$</span> essay publish
                    </p>
                    <p>
                      <span
                        style={{ color: "var(--background)", opacity: 0.9 }}
                      >
                        ✓
                      </span>{" "}
                      <span style={{ opacity: 0.7 }}>committed to main</span>
                    </p>
                    <p>
                      <span
                        style={{ color: "var(--background)", opacity: 0.9 }}
                      ...
                      <span style={{ opacity: 0.7 }}>
                        live at tim.essay.sh/why-i-left-substack
                      </span>
                    </p>
              ...
              <div style={{ border: "1px dashed var(--border)" }}>
                ...
                >
                  {/* markdown pane */}
                  <div
                    className="px-4 py-4 text-xs font-mono space-y-2"
                    style={{
                  ...
                  {/* preview pane */}
                  <div
                    className="px-4 py-4 text-xs space-y-2"
                    style={{ color: "var(--muted)" }}
                  >
                    ...
                    <p className="leading-relaxed" style={{ opacity: 0.7 }}>
                      After three years and 4,000 subscribers, I decided...
                    </p>
                    <p className="leading-relaxed" style={{ opacity: 0.7 }}>
                      The thing about platforms is that they own the...
                    </p>
                  </div>
                </div>
                {/* publish button */}
                ...
                >
                  For when you're on the couch, at the coffee shop, or
                  explaining the product to someone who doesn't own a terminal.
                </p>
              </div>
            </div>
            <p
        ...
        <section style={{ borderTop: "1px dashed var(--border)" }}>
          <div className="max-w-2xl mx-auto px-6 py-14 text-center">
            <p
              ...
              style={{ color: "var(--muted)" }}
            >
              Built for developers who write, writers who code, and anyone tired
              of their blog being held hostage by a CMS.
            </p>
          </div>
        </section>
