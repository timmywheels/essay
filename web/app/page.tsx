    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-6">
      <div className="max-w-md w-full space-y-8 text-center">
        <div className="space-y-2">
          <h1 className="text-2xl font-semibold tracking-tight">essay.sh</h1>
          <p className="text-zinc-500 text-sm leading-relaxed">
            The fastest way to put words on the internet.
          </p>
        </div>
...
function GitHubMark() {
  return (
    <svg viewBox="0 0 98 96" width="20" height="20" fill="white" aria-hidden="true">
